/* STANDALONE PATCH (27 Aug 2026): the five runtime texture URLs are
   swapped for bundled data-URL imports so this file runs from file:// with
   zero network and no server. NOTHING else is changed from the site's
   src/gl/ConsultHand.js. */
import BILL_TEXTURE_URL from "../../assets/bill-franklin.jpg";
import HAND_TEXTURE_URL from "../../assets/consult-hand-v2.png";
import PLANT_ATLAS_URL from "../../assets/consult-plant-atlas-v3.png";
import ECOLOGY_ATLAS_URL from "../../assets/consult-ecology-atlas-v1.png";
import PAPER_BIRD_URL from "../../assets/consult-paper-bird-v1.png";
import {
  AdditiveBlending,
  BufferGeometry,
  CanvasTexture,
...
export function createConsultHand(canvas) {
  ...
  const handTexture = new TextureLoader().load(HAND_TEXTURE_URL, () => {
